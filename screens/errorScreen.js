...
const errorScreen =
  ...
  <p>▪ it's not a playlist made/generated by Spotify </p>
  <div class="flex gap-4 my-4">
    <img src="/madeBySpotify1.png" alt="Spotify Discover Weekly playlist example" class="h-24" />
    <img src="/madeBySpotify2.png" alt="This is YOASOBI playlist example" class="h-24" />
  </div>
  <br
  ...
  <textarea autofocus rows="4" id="linkInput" type="text" class="leading-[1.2] text-[72px] font-light text-[#E4E4E4] placeholder:text-[#E4E4E4] font-inter caret-[#1DB954] w-full outline-none resize-none overflow-hidden h-full" placeholder="try another link"></textarea>
</form>
